...
namespace ETicaretAPI.Persistence.Migrations
{
    ...
    [Migration("20231202211454_mig_11")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ETicaretAPI.Domain.Entites.CompletedOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ETicaretAPI.Domain.Entites.Endpoint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ETicaretAPI.Domain.Entites.Menu", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ProductProductImagesFile", b =>
                {
                    ...
                    b.ToTable("ProductProductImagesFile");
                });
            ...
            modelBuilder.Entity("ETicaretAPI.Domain.Entites.ProductImagesFile", b =>
                {
                    b.HasBaseType("ETicaretAPI.Domain.Entites.File");
            ...
            modelBuilder.Entity("AppRoleEndpoint", b =>
                {
                    b.HasOne("ETicaretAPI.Domain.Entites.Endpoint", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ETicaretAPI.Domain.Entites.Basket", b =>
                {
                    b.HasOne("ETicaretAPI.Domain.Entites.Identity.AppUser", "User")
                        .WithMany("Baskets")
            ...
            modelBuilder.Entity("ETicaretAPI.Domain.Entites.CompletedOrder", b =>
                {
                    b.HasOne("ETicaretAPI.Domain.Entites.Order", "Order")
                        ...
                        .HasForeignKey("ETicaretAPI.Domain.Entites.CompletedOrder", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ETicaretAPI.Domain.Entites.Endpoint", b =>
                {
                    b.HasOne("ETicaretAPI.Domain.Entites.Menu", "Menu")
                        .WithMany("Endpoints")
            ...
            modelBuilder.Entity("ProductProductImagesFile", b =>
                {
                    b.HasOne("ETicaretAPI.Domain.Entites.ProductImagesFile", null)
                        .WithMany()
