...
namespace ETicaretAPI.Persistence
{
    public static class ServiceRegistration
    {
        public static void AddPersistenceServices(this IServiceCollection services)
        {
            ...
            services.AddScoped<IProductImageFileReadRepository,ProductImageReadRepostiory>();
            services.AddScoped<IProductImageFileWriteRepository, ProductImageWriteRepostiory>();
